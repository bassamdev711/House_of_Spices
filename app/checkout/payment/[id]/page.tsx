        ...
        <div className="w-full max-w-[640px] bg-white shadow-sm p-8 md:p-12 border border-black/5">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <button 
              ...
              className="w-full bg-emerald text-ivory font-bold py-5 flex justify-center items-center gap-3 hover:bg-deep-green transition-colors duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
            >
