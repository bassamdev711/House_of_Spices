              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <div className="flex rounded-md shadow-sm">
                    <input type="number" name="size" placeholder="مثال: 500" dir="ltr" 
                    ...
                    <select name="unit" defaultValue="جرام" className="rounded-r-md border border-l-0 border-gray-300 bg-gray-50 text-gray-700 px-3 py-2 text-sm focus:border-black focus:outline-none font-bold min-w-[80px]">
