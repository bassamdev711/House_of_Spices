                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      <input type="text" name="size" placeholder="مثال: 500" dir="ltr" 
                        className="w-2/3 rounded-md border-gray-300 border p-2 text-sm text-gray-900 bg-white" />
                      <select name="unit" defaultValue="جرام" className="w-1/3 rounded-md border-gray-300 border p-2 text-sm text-gray-900 bg-white">
