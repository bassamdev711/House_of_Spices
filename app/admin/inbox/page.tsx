            ...
            <>
              ...
              <div className="p-8 flex-1 overflow-y-auto">
                ...
                <div className="mt-8 pt-8 border-t border-black/5">
                  <a 
                    href={`mailto:${selectedMessage.email}?subject=رد من توابل بيت البهارات&body=مرحباً ${selectedMessage.name}،%0D%0A%0D%0Aرداً على رسالتك:%0D%0A"${selectedMessage.message}"%0D%0A%0D%0A`}
