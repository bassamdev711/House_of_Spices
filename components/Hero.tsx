...
export default function Hero({ data = {} }: { data?: any }) {
  ...
  return (
    <section
      id="hero"
      className="relative w-full min-h-[100dvh] overflow-hidden bg-surface flex items-center justify-center"
    >
      ...
      <div className="relative z-10 container mx-auto px-6 sm:px-10 lg:px-16 pt-24 pb-16 flex items-center justify-center">
        <div
          dir="rtl"
          className="min-h-[calc(100dvh-8rem)] flex items-center w-full"
        >
            ...
            >
              ...
              >
                <button
                  ...
                  "
                >
                  <span className="block lg:hidden">تسوق الان</span>
                  <span className="hidden lg:block">{data.heroPrimaryButton || "اكتشف المجموعة"}</span>
                </button>
              ...
              <motion.div
                ...
                className="hidden lg:flex flex-wrap items-center gap-x-6 gap-y-3 mt-10 text-xs sm:text-sm text-foreground/45"
              >
