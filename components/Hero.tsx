...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative w-full min-h-[100dvh] overflow-hidden bg-ivory">
      ...
      {/* Main Container */}
      <div className="max-w-7xl mx-auto px-6 lg:px-12 h-full flex flex-col justify-center min-h-[100dvh] pt-24 lg:pt-32 pb-16 lg:pb-20 relative z-10" dir="rtl">
        
        {/* Grid Layout */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 xl:gap-24 items-center w-full flex-grow">
