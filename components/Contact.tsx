            ...
            <div className="space-y-8">
              <div className="flex items-start gap-6 group">
                ...
                <div>
                  ...
                  <p className="text-deep-green/60 font-light" dir="ltr">+967 777 777 777</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-6 group">
                ...
                <div>
                  ...
                  <p className="text-deep-green/60 font-light">info@tif-perfumes.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-6 group">
                ...
                <div>
                  ...
                  <p className="text-deep-green/60 font-light">صنعاء، الجمهورية اليمنية</p>
                </div>
              </div>
            </div>
          </motion.div>
