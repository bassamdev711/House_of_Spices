  ...
  return (
    <section id="about" className="relative py-24 md:py-32 bg-ivory overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="relative min-h-[500px] md:min-h-[600px] w-full overflow-hidden bg-emerald shadow-2xl flex items-center justify-center">
          ...
          {/* Luxury Overlay */}
          <div className="absolute inset-0 bg-gradient-to-b from-emerald/90 via-emerald/70 to-emerald/90"></div>
